...
from scripts.training.regression import TrainModel  # noqa: E402
from scripts.training.preprocessed import FinalData  # noqa: E402
...
class TrainPipeline:
    ...
    def save_submission(self):
        ...
        submission = pd.DataFrame(
            {"ID": range(len(self.predictions)), "item_cnt_month": self.predictions}
        )
